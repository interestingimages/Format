...
The `thumbnail/design/thumbnail.ai` file is licensed under a
[Creative Commons Attribution-ShareAlike 4.0 International License](http://creativecommons.org/licenses/by-sa/4.0/).

### Fonts

The design uses the following fonts:

#### Alte DIN 1451

I couldn't find the original LICENSE file - if anybody has it please do open an issue.
